        ...
        <main className="flex-1 p-6 space-y-6 overflow-y-auto bg-gray-50">
          ...
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="h-[520px]"> {/* Adjusted height to match search + chart */}
                <CompanyOverview companyData={companyData} />
              </div>
              <div className="flex flex-col gap-6">
                <div className="w-full"> {/* Made search bar full width */}
                  <CompanySearch onCompanySelect={handleCompanySelect} />
                </div>
                <StockChart />
              </div>
            </div>
            <CompanyNews companyData={companyData} newsData={newsData} />
          </div>
        </main>
      </div>
    </div>
