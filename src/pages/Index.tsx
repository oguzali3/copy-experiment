    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="container pt-32 pb-20 text-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Left side - Bar Chart */}
          <div className="absolute bottom-14 left-16 w-32 h-24 bg-white/90 rounded-xl shadow-lg p-4 animate-[fade-in_0.5s,scale-in_0.5s] backdrop-blur-sm border border-gray-100">
