    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="container py-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 text-[#111827] relative inline-block">
          Make Smarter Investment <span className="text-[#3B82F6]">Decisions</span>
          <span className="absolute bottom-0 left-1/4 right-1/4 h-1 bg-[#3B82F6]/60 rounded-full transform skew-x-12"></span>
        </h1>
      ...
      <section className="container py-16 bg-gray-50 rounded-2xl">
        <h2 className="text-3xl font-bold text-center mb-8 text-[#111827]">Real-Time Market <span className="text-[#3B82F6]">Insights</span></h2>
        <LiveStockData />
        <div className="mt-8">
          <StockChart />
        </div>
      ...
      <section className="container py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-[#111827]">Why Choose Our <span className="text-[#3B82F6]">Platform?</span></h2>
      ...
      {/* Testimonials */}
      <section className="container py-16 bg-gray-50 rounded-2xl">
        <h2 className="text-3xl font-bold text-center mb-12 text-[#111827]">What Our <span className="text-[#3B82F6]">Users Say</span></h2>
        <Testimonials />
      </section>

      {/* CTA */}
      <section className="container py-20 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#111827]">Ready to Transform Your <span className="text-[#3B82F6]">Investment Strategy?</span></h2>
        <p className="text-xl text-gray-600 mb-8">Join thousands of investors making data-driven decisions</p>
        <Button size="lg" className="text-lg px-8 bg-[#3B82F6] hover:bg-[#3B82F6]/90 text-white">
          Get Started Now
        </Button>
      </section>
    </div>
