...
export const DashboardHeader = () => {
  ...
  return <div className="h-16 flex items-center px-6 gap-4 flex-shrink-0 border-b bg-white dark:bg-[#1c1c20] dark:border-gray-800">
      ...
      <div className="flex items-center gap-3 ml-auto">
        ...
        <Button className="text-white bg-[#27aa43]">
          Upgrade
        </Button>
        <ProfileMenu />
      </div>
