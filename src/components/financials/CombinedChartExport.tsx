...
interface CombinedChartExportProps {
...
const CombinedChartExport: React.FC<CombinedChartExportProps> = ({
  data,
  companies,
  metrics,
  metricTypes,
  ...
  metricSettings,
  stackedMetrics = [],
  fileName = 'combined-chart-export'
}) => {
    ...
    if (!previewUrl && exportChartRef.current) {
      ...
      import('html-to-image').then(({ toPng }) => {
        toPng(chartContainer, {
          ...
          link.href = dataUrl;
          link.download = `${fileName || 'combined-chart-export'}.png`;
  ...
  // Generate formatted legend texts for display
  ...
  return (
    <>
      ...
      >
        <Download size={16} />
        <span>Export Combined Chart</span>
      </Button>
      
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle>Export Combined Chart</DialogTitle>
          </DialogHeader>
          ...
          <div className="py-4">
            {loading ? (
              ...
              <div 
                className="relative" 
                style={{ width: '800px', height: '567px', overflow: 'hidden' }} 
                ref={exportChartRef} 
                data-testid="export-chart-container"
              >
                ...
                <div 
                  ...
                  style={{ width: '150px', height: '70px', opacity: 0.9 }}
                >
...
export default CombinedChartExport;