  ...
  return (
    ...
    >
          ...
          return (
            <Link 
              ...
              className={cn(
                ...
                isActive 
                  ? "bg-[#eef1f5] text-[#077dfa] dark:bg-gray-800 dark:text-blue-400" 
                  : "text-gray-600 hover:bg-[#eef1f5] hover:text-[#077dfa] dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-blue-400", 
      ...
      <div className="p-3 mt-auto">
        ...
        {user && (
          <div className={cn("flex items-center mt-3 py-2 px-3 rounded-md", isHovered ? "justify-start" : "justify-center")}>
